...
from wealthtech_api.types.data.source.positions.latest import models
...
def test_list_200_generated_success_default():
    ...
    response = client.data.source.positions.latest.list(
        pager_limit=123,
        pager_page=123,
        data={
    ...
    adapter = TypeAdapter(models.GetDataSourcePositionsLatestResponse)
...
async def test_await_list_200_generated_success_default():
    ...
    response = await client.data.source.positions.latest.list(
        pager_limit=123,
        pager_page=123,
        data={
            "abs_cost_basis": 123.45,
