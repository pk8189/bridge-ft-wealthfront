...
from wealthtech_api.types.data.source.realized_gain_loss.latest import models
...
def test_list_200_generated_success_default():
    ...
    response = client.data.source.realized_gain_loss.latest.list(
        pager_limit=123,
        pager_page=123,
        data={
    ...
    adapter = TypeAdapter(models.GetDataSourceRealizedGainLossLatestResponse)
...
async def test_await_list_200_generated_success_default():
    ...
    response = await client.data.source.realized_gain_loss.latest.list(
        pager_limit=123,
        pager_page=123,
        data={
            "abs_closed_units": 123.45,
