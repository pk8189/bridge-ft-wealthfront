...
from wealthtech_api.types.reporting.printable_reports.delete_many import models
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.printable_reports.delete_many.create(
        pager_limit=123, pager_page=123, data={"ids": [123]}
    )
    adapter = TypeAdapter(models.PostReportingPrintableReportsDeleteManyResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.printable_reports.delete_many.create(
        pager_limit=123, pager_page=123, data={"ids": [123]}
    )
    adapter = TypeAdapter(models.PostReportingPrintableReportsDeleteManyResponse)
    adapter.validate_python(response)
