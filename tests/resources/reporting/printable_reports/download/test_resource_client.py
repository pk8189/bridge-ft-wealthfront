...
from wealthtech_api.types.reporting.printable_reports.download import models
...
def test_create_by_id_200_generated_success_default():
    ...
    response = client.reporting.printable_reports.download.create_by_id(
        id=123,
        pager_limit=123,
        pager_page=123,
...
async def test_await_create_by_id_200_generated_success_default():
    ...
    response = await client.reporting.printable_reports.download.create_by_id(
        id=123,
        pager_limit=123,
        pager_page=123,
        data={"accept": "string", "content_type": "string"},
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.printable_reports.download.create(
        pager_limit=123, pager_page=123, data={"ids": [123]}
    )
    adapter = TypeAdapter(models.PostReportingPrintableReportsDownloadResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.printable_reports.download.create(
        pager_limit=123, pager_page=123, data={"ids": [123]}
    )
    adapter = TypeAdapter(models.PostReportingPrintableReportsDownloadResponse)
    adapter.validate_python(response)
