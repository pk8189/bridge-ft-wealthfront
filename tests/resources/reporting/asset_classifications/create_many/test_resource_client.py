...
from wealthtech_api.types.reporting.asset_classifications.create_many import models
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.asset_classifications.create_many.create(
        pager_limit=123,
        pager_page=123,
        data=[
            {
    ...
    adapter = TypeAdapter(models.PostReportingAssetClassificationsCreateManyResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.asset_classifications.create_many.create(
        pager_limit=123,
        pager_page=123,
        data=[
            {
