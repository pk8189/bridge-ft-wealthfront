...
from wealthtech_api.types.reporting.asset_classifications.filter import models
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.asset_classifications.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "class_tag_id": 435,
    ...
    adapter = TypeAdapter(models.PostReportingAssetClassificationsFilterResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.asset_classifications.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "class_tag_id": 435,
