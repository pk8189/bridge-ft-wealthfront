...
from wealthtech_api.types.reporting.benchmarks.delete_many import models
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.benchmarks.delete_many.create(
        pager_limit=123, pager_page=123, data={"ids": [123]}
    )
    adapter = TypeAdapter(models.PostReportingBenchmarksDeleteManyResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.benchmarks.delete_many.create(
        pager_limit=123, pager_page=123, data={"ids": [123]}
    )
    adapter = TypeAdapter(models.PostReportingBenchmarksDeleteManyResponse)
    adapter.validate_python(response)
