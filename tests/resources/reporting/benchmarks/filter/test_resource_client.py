...
from wealthtech_api.types.reporting.benchmarks.filter import models
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.benchmarks.filter.create(
        pager_limit=123,
        pager_page=123,
        data={"firm_id": 39, "id": 11149, "name": "S&P 500", "slug": "sandp-500"},
    )
    adapter = TypeAdapter(models.PostReportingBenchmarksFilterResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.benchmarks.filter.create(
        pager_limit=123,
        pager_page=123,
        data={"firm_id": 39, "id": 11149, "name": "S&P 500", "slug": "sandp-500"},
    )
