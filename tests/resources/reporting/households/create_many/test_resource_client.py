...
from wealthtech_api.types.reporting.households.create_many import models
...
def test_create_200_generated_success_default():
    ...
    response = client.reporting.households.create_many.create(
        pager_limit=123,
        pager_page=123,
        data=[
    ...
    adapter = TypeAdapter(models.PostReportingHouseholdsCreateManyResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.reporting.households.create_many.create(
        pager_limit=123,
        pager_page=123,
        data=[
            {"firm_id": 39, "name": "Joe and Rebecca Jones Household"},
