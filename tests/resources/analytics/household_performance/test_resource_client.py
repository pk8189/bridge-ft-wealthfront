...
import typing
from wealthtech_api.types.analytics.household_performance import models
...
def test_create_200_generated_success_default():
    ...
    response = client.analytics.household_performance.create(
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.analytics.household_performance.create(
        data={"as_of_date": "2022-07-31", "entity_ids": [27585, 28028]}
    )
    adapter = TypeAdapter(
        typing.List[models.PostAnalyticsHouseholdPerformanceResponseItem]
