...
from wealthtech_api.types.analytics.aum.filter import models
...
def test_create_200_generated_success_default():
    ...
    response = client.analytics.aum.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
    ...
    adapter = TypeAdapter(models.PostAnalyticsAumFilterResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.analytics.aum.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "as_of_date": "2004-05-14T00:00:00Z",
