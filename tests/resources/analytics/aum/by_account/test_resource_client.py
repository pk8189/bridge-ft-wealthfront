...
from wealthtech_api.types.analytics.aum.by_account import models
...
def test_create_200_generated_success_default():
    ...
    response = client.analytics.aum.by_account.create(
        data={"account_ids": [383649, 383912, 383930], "as_of_date": "2023-07-26"}
    )
    adapter = TypeAdapter(models.PostAnalyticsAumByAccountResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.analytics.aum.by_account.create(
        data={"account_ids": [383649, 383912, 383930], "as_of_date": "2023-07-26"}
    )
    adapter = TypeAdapter(models.PostAnalyticsAumByAccountResponse)
    adapter.validate_python(response)
