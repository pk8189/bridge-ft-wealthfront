...
from wealthtech_api.types.billing.splits.filter import models
...
def test_create_200_generated_success_default():
    ...
    response = client.billing.splits.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "firm_id": 39,
    ...
    adapter = TypeAdapter(models.PostBillingSplitsFilterResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.billing.splits.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "firm_id": 39,
