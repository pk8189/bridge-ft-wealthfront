...
from wealthtech_api.types.billing.splits.create_many import models
...
def test_create_200_generated_success_default():
    ...
    response = client.billing.splits.create_many.create(
        pager_limit=123,
        pager_page=123,
        data=[
            {
    ...
    adapter = TypeAdapter(models.PostBillingSplitsCreateManyResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.billing.splits.create_many.create(
        pager_limit=123,
        pager_page=123,
        data=[
            {
