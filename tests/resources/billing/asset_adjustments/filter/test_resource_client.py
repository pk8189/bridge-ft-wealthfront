...
from wealthtech_api.types.billing.asset_adjustments.filter import models
...
def test_create_200_generated_success_default():
    ...
    response = client.billing.asset_adjustments.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "adjustment_type": "e",
    ...
    adapter = TypeAdapter(models.PostBillingAssetAdjustmentsFilterResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.billing.asset_adjustments.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "adjustment_type": "e",
