...
from wealthtech_api.types.billing.groups.filter import models
...
def test_create_200_generated_success_default():
    ...
    response = client.billing.groups.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "firm_id": 39,
    ...
    adapter = TypeAdapter(models.PostBillingGroupsFilterResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.billing.groups.filter.create(
        pager_limit=123,
        pager_page=123,
        data={
            "firm_id": 39,
