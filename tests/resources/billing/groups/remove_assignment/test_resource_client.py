...
from wealthtech_api.types.billing.groups.remove_assignment import models
...
def test_create_200_generated_success_default():
    ...
    response = client.billing.groups.remove_assignment.create(
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.billing.groups.remove_assignment.create(
        pager_limit=123, pager_page=123, data={"group_id": 315948, "id": 703866}
    )
    adapter = TypeAdapter(models.Delete)
    adapter.validate_python(response)
