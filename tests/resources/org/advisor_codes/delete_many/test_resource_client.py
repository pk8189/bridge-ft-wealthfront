...
from wealthtech_api.types.org.advisor_codes.delete_many import models
...
def test_create_200_generated_success_default():
    ...
    response = client.org.advisor_codes.delete_many.create(data={"ids": [123]})
    adapter = TypeAdapter(models.PostOrgAdvisorCodesDeleteManyResponse)
...
async def test_await_create_200_generated_success_default():
    ...
    response = await client.org.advisor_codes.delete_many.create(data={"ids": [123]})
    adapter = TypeAdapter(models.PostOrgAdvisorCodesDeleteManyResponse)
    adapter.validate_python(response)
