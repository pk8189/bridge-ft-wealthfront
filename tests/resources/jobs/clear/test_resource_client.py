...
def test_create_200_generated_success():
    ...
    response = client.jobs.clear.create(pager_limit=123, pager_page=123)
    adapter = TypeAdapter(models.PostJobsClearResponse)
...
async def test_await_create_200_generated_success():
    ...
    response = await client.jobs.clear.create(pager_limit=123, pager_page=123)
    adapter = TypeAdapter(models.PostJobsClearResponse)
    adapter.validate_python(response)
