...
class Firm(pydantic.BaseModel):
    ...
    billing_partition_option: typing.Optional[
        typing_extensions.Literal["Y", "M", "W", "Q", "D"]
    ...
    reporting_frequency: typing.Optional[
        typing_extensions.Literal["D", "W", "M", "Q", "Y"]
...
class GetOrgFirmsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[Firm] = pydantic.Field(alias="data", default=None)
...
class PutOrgFirmsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetOrgFirmsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
