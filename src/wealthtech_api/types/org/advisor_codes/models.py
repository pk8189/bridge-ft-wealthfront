...
class GetOrgAdvisorCodesResponseDataItem(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    source: typing.Optional[
        typing_extensions.Literal[
            "DST", "SWB", "TIA", "MLT", "EGB", "PER", "NFS", "FPR", "IBK", "APX"
        ]
...
class PostOrgAdvisorCodesResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    source: typing.Optional[
        typing_extensions.Literal[
            "NFS", "FPR", "IBK", "APX", "PER", "SWB", "TIA", "DST", "EGB", "MLT"
        ]
    ] = pydantic.Field(alias="source", default=None)
    updated_at_utc: typing.Optional[str] = pydantic.Field(
        alias="updated_at_utc", default=None
...
class GetOrgAdvisorCodesResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[typing.List[GetOrgAdvisorCodesResponseDataItem]] = (
