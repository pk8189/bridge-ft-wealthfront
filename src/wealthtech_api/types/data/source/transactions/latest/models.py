...
class SourceTransaction(pydantic.BaseModel):
    ...
    category: typing.Optional[
        typing_extensions.Literal["crp", "oth", "xfr", "trd", "inc"]
    ...
    source: typing.Optional[
        typing_extensions.Literal[
            "APX", "FPR", "TDA", "NFS", "IBK", "DST", "EGB", "SWB", "MLT", "TIA", "PER"
        ]
...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "IBK", "NFS", "SWB", "MLT", "FPR", "TIA", "DST", "APX", "EGB", "PER"
        ]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["DT", "ETF", "UC", "CE", "MX", "CA", "EQ", "CR"]
...
class GetDataSourceTransactionsLatestResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceTransactionsLatestResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceTransactionsLatestResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    accounts: typing.Optional[
        GetDataSourceTransactionsLatestResponseRelatedAccounts
    ] = pydantic.Field(alias="accounts", default=None)
    securities: typing.Optional[
        GetDataSourceTransactionsLatestResponseRelatedSecurities
    ] = pydantic.Field(alias="securities", default=None)


class GetDataSourceTransactionsLatestResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    related: typing.Optional[GetDataSourceTransactionsLatestResponseRelated] = (
