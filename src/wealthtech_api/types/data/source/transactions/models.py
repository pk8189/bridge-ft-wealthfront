...
class SourceTransaction(pydantic.BaseModel):
    ...
    category: typing.Optional[
        typing_extensions.Literal["inc", "xfr", "oth", "crp", "trd"]
    ...
    source: typing.Optional[
        typing_extensions.Literal[
            "IBK", "MLT", "FPR", "APX", "PER", "TDA", "TIA", "SWB", "EGB", "DST", "NFS"
        ]
...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "DST", "NFS", "IBK", "APX", "PER", "TIA", "FPR", "EGB", "MLT", "SWB"
        ]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["MX", "DT", "CE", "CR", "CA", "UC", "EQ", "ETF"]
...
class GetDataSourceTransactionsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceTransactionsResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceTransactionsResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceTransactionsResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    accounts: typing.Optional[GetDataSourceTransactionsResponseRelatedAccounts] = (
        pydantic.Field(alias="accounts", default=None)
    )
    securities: typing.Optional[GetDataSourceTransactionsResponseRelatedSecurities] = (
        pydantic.Field(alias="securities", default=None)
    )


class GetDataSourceTransactionsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[typing.List[SourceTransaction]] = pydantic.Field(
        alias="data", default=None
    )
    has_next: typing.Optional[bool] = pydantic.Field(alias="has_next", default=None)
    has_previous: typing.Optional[bool] = pydantic.Field(
    ...
    related: typing.Optional[GetDataSourceTransactionsResponseRelated] = pydantic.Field(
