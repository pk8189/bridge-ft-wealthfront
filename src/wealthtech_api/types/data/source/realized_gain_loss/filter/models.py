...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "APX", "PER", "IBK", "NFS", "FPR", "SWB", "TIA", "MLT", "DST", "EGB"
        ]
    ...
    status: typing.Optional[
        typing_extensions.Literal["funded", "stale", "closed", "papered"]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["CR", "EQ", "UC", "CA", "MX", "CE", "DT", "ETF"]
...
class PostDataSourceRealizedGainLossFilterResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostDataSourceRealizedGainLossFilterResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostDataSourceRealizedGainLossFilterResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    accounts: typing.Optional[
        PostDataSourceRealizedGainLossFilterResponseRelatedAccounts
    ] = pydantic.Field(alias="accounts", default=None)
    securities: typing.Optional[
        PostDataSourceRealizedGainLossFilterResponseRelatedSecurities
    ] = pydantic.Field(alias="securities", default=None)


class PostDataSourceRealizedGainLossFilterResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[SourceRealizedGainLoss] = pydantic.Field(
    ...
    related: typing.Optional[PostDataSourceRealizedGainLossFilterResponseRelated] = (
