...
class GetDataSourceRealizedGainLossLatestBody(typing_extensions.TypedDict):
    """
...
class _SerializerGetDataSourceRealizedGainLossLatestBody(pydantic.BaseModel):
    """
    Serializer for GetDataSourceRealizedGainLossLatestBody handling case conversions
