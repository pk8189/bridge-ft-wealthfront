...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "APX", "NFS", "EGB", "TIA", "FPR", "DST", "SWB", "PER", "MLT", "IBK"
        ]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["DT", "CR", "CA", "MX", "ETF", "UC", "EQ", "CE"]
...
class GetDataSourceRealizedGainLossIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceRealizedGainLossResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceRealizedGainLossResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceRealizedGainLossResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    accounts: typing.Optional[GetDataSourceRealizedGainLossResponseRelatedAccounts] = (
        pydantic.Field(alias="accounts", default=None)
    )
    securities: typing.Optional[
        GetDataSourceRealizedGainLossResponseRelatedSecurities
    ] = pydantic.Field(alias="securities", default=None)


class GetDataSourceRealizedGainLossResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    related: typing.Optional[GetDataSourceRealizedGainLossResponseRelated] = (
