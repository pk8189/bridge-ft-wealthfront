...
class PostDataSourceAccountBalancesFilterBody(typing_extensions.TypedDict):
    """
...
class _SerializerPostDataSourceAccountBalancesFilterBody(pydantic.BaseModel):
    """
    Serializer for PostDataSourceAccountBalancesFilterBody handling case conversions
