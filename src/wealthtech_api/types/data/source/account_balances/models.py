...
class SourceAccountBalance(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    abs_cash_contribution: typing.Optional[float] = pydantic.Field(
        alias="abs_cash_contribution", default=None
    )
    abs_cash_withdrawal: typing.Optional[float] = pydantic.Field(
        alias="abs_cash_withdrawal", default=None
    )
    abs_expense: typing.Optional[float] = pydantic.Field(
        alias="abs_expense", default=None
    )
    abs_income: typing.Optional[float] = pydantic.Field(
        alias="abs_income", default=None
    )
    abs_management_fee: typing.Optional[float] = pydantic.Field(
        alias="abs_management_fee", default=None
    )
    abs_non_performing_expense: typing.Optional[float] = pydantic.Field(
        alias="abs_non_performing_expense", default=None
    )
    abs_non_performing_income: typing.Optional[float] = pydantic.Field(
        alias="abs_non_performing_income", default=None
    )
    abs_security_contribution: typing.Optional[float] = pydantic.Field(
        alias="abs_security_contribution", default=None
    )
    abs_security_withdrawal: typing.Optional[float] = pydantic.Field(
        alias="abs_security_withdrawal", default=None
    )
    ...
    cash_value: typing.Optional[float] = pydantic.Field(
        alias="cash_value", default=None
    )
    ...
    net_income: typing.Optional[float] = pydantic.Field(
        alias="net_income", default=None
    )
    net_non_performing_income: typing.Optional[float] = pydantic.Field(
        alias="net_non_performing_income", default=None
    )
    ...
    securities_value: typing.Optional[float] = pydantic.Field(
        alias="securities_value", default=None
    )
    ...
    total_abs_contribution: typing.Optional[float] = pydantic.Field(
        alias="total_abs_contribution", default=None
    )
    total_abs_withdrawal: typing.Optional[float] = pydantic.Field(
        alias="total_abs_withdrawal", default=None
    )
    total_net_contribution: typing.Optional[float] = pydantic.Field(
        alias="total_net_contribution", default=None
    )
    total_unrealized_gain_loss: typing.Optional[float] = pydantic.Field(
        alias="total_unrealized_gain_loss", default=None
    )
    total_unrealized_gain_loss_reported: typing.Optional[float] = pydantic.Field(
        alias="total_unrealized_gain_loss_reported", default=None
    )
...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "NFS", "APX", "PER", "FPR", "EGB", "IBK", "MLT", "SWB", "TIA", "DST"
        ]
...
class GetDataSourceAccountBalancesIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[SourceAccountBalance] = pydantic.Field(
...
class GetDataSourceAccountBalancesResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourceAccountBalancesResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    accounts: typing.Optional[GetDataSourceAccountBalancesResponseRelatedAccounts] = (
        pydantic.Field(alias="accounts", default=None)
    )


class GetDataSourceAccountBalancesResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[typing.List[SourceAccountBalance]] = pydantic.Field(
        alias="data", default=None
    )
    has_next: typing.Optional[bool] = pydantic.Field(alias="has_next", default=None)
    has_previous: typing.Optional[bool] = pydantic.Field(
    ...
    related: typing.Optional[GetDataSourceAccountBalancesResponseRelated] = (
