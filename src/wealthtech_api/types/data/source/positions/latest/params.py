...
class GetDataSourcePositionsLatestBody(typing_extensions.TypedDict):
    """
...
class _SerializerGetDataSourcePositionsLatestBody(pydantic.BaseModel):
    """
    Serializer for GetDataSourcePositionsLatestBody handling case conversions
