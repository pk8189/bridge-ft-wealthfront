...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "SWB", "APX", "NFS", "IBK", "EGB", "MLT", "TIA", "FPR", "DST", "PER"
        ]
    ...
    required_cash_frequency: typing.Optional[
        typing_extensions.Literal["O", "Q", "M"]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["MX", "UC", "CR", "DT", "EQ", "ETF", "CA", "CE"]
...
class PostDataSourcePositionsFilterResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostDataSourcePositionsFilterResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostDataSourcePositionsFilterResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    accounts: typing.Optional[PostDataSourcePositionsFilterResponseRelatedAccounts] = (
        pydantic.Field(alias="accounts", default=None)
    )
    securities: typing.Optional[
        PostDataSourcePositionsFilterResponseRelatedSecurities
    ] = pydantic.Field(alias="securities", default=None)


class PostDataSourcePositionsFilterResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    related: typing.Optional[PostDataSourcePositionsFilterResponseRelated] = (
