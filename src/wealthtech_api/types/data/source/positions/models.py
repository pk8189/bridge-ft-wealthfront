...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "DST", "NFS", "SWB", "TIA", "IBK", "PER", "EGB", "APX", "MLT", "FPR"
        ]
    ...
    status: typing.Optional[
        typing_extensions.Literal["closed", "funded", "papered", "stale"]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["DT", "MX", "ETF", "CA", "EQ", "UC", "CE", "CR"]
...
class GetDataSourcePositionsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[SourcePosition] = pydantic.Field(alias="data", default=None)
...
class GetDataSourcePositionsResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourcePositionsResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetDataSourcePositionsResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    accounts: typing.Optional[GetDataSourcePositionsResponseRelatedAccounts] = (
        pydantic.Field(alias="accounts", default=None)
    )
    securities: typing.Optional[GetDataSourcePositionsResponseRelatedSecurities] = (
        pydantic.Field(alias="securities", default=None)
    )


class GetDataSourcePositionsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    related: typing.Optional[GetDataSourcePositionsResponseRelated] = pydantic.Field(
