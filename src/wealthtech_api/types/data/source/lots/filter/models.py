...
class Account(pydantic.BaseModel):
    ...
    custodian: typing.Optional[
        typing_extensions.Literal[
            "APX", "SWB", "NFS", "DST", "EGB", "MLT", "FPR", "IBK", "TIA", "PER"
        ]
...
class Security(pydantic.BaseModel):
    ...
    master_asset_class: typing.Optional[
        typing_extensions.Literal["EQ", "ETF", "MX", "DT", "CE", "CA", "CR", "UC"]
...
class PostDataSourceLotsFilterResponseRelatedAccounts(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostDataSourceLotsFilterResponseRelatedSecurities(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PostDataSourceLotsFilterResponseRelated(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )

    accounts: typing.Optional[PostDataSourceLotsFilterResponseRelatedAccounts] = (
        pydantic.Field(alias="accounts", default=None)
    )
    securities: typing.Optional[PostDataSourceLotsFilterResponseRelatedSecurities] = (
        pydantic.Field(alias="securities", default=None)
    )


class PostDataSourceLotsFilterResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    related: typing.Optional[PostDataSourceLotsFilterResponseRelated] = pydantic.Field(
