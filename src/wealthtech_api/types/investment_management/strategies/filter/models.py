...
class Strategy(pydantic.BaseModel):
    ...
    risk_category: typing.Optional[
        typing_extensions.Literal["AG", "CO", "MC", "MO", "GR", "CP", "MG"]
    ...
    strategy_type: typing.Optional[
        typing_extensions.Literal["Alternatives", "Core", "Satellite", "Income"]
...
class PostInvestmentManagementStrategiesFilterResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
