...
class Strategy(pydantic.BaseModel):
    ...
    risk_category: typing.Optional[
        typing_extensions.Literal["MG", "CO", "CP", "AG", "MC", "MO", "GR"]
    ...
    strategy_type: typing.Optional[
        typing_extensions.Literal["Satellite", "Income", "Alternatives", "Core"]
...
class GetInvestmentManagementStrategiesIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[Strategy] = pydantic.Field(alias="data", default=None)
...
class PostInvestmentManagementStrategiesResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PutInvestmentManagementStrategiesResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PutInvestmentManagementStrategiesIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetInvestmentManagementStrategiesResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
