...
class PostBillingGroupsCreateManyBodyItemAssignmentsItem(typing_extensions.TypedDict):
    """
...
class _SerializerPostBillingGroupsCreateManyBodyItemAssignmentsItem(pydantic.BaseModel):
    """
    Serializer for PostBillingGroupsCreateManyBodyItemAssignmentsItem handling case conversions
...
class PostBillingGroupsCreateManyBodyItem(typing_extensions.TypedDict):
    """
    No description specified
    """

    assignments: typing_extensions.NotRequired[
        typing.List[PostBillingGroupsCreateManyBodyItemAssignmentsItem]
    ]
...
class _SerializerPostBillingGroupsCreateManyBodyItem(pydantic.BaseModel):
    """
    Serializer for PostBillingGroupsCreateManyBodyItem handling case conversions
    and file omitions as dictated by the API
    """
    ...
    assignments: typing.Optional[
        typing.List[_SerializerPostBillingGroupsCreateManyBodyItemAssignmentsItem]
