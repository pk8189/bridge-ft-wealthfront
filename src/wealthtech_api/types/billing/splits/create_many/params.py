...
class PostBillingSplitsCreateManyBodyItem(typing_extensions.TypedDict):
    """
...
class _SerializerPostBillingSplitsCreateManyBodyItem(pydantic.BaseModel):
    """
    Serializer for PostBillingSplitsCreateManyBodyItem handling case conversions
