...
class PostBillingMinimumsBody(typing_extensions.TypedDict):
    """
    ...
    value_type: typing_extensions.NotRequired[typing_extensions.Literal["P", "F"]]


class _SerializerPostBillingMinimumsBody(pydantic.BaseModel):
    """
    Serializer for PostBillingMinimumsBody handling case conversions
...
class Minimuns(typing_extensions.TypedDict):
    """
    No description specified
    """
...
class _SerializerMinimuns(pydantic.BaseModel):
    """
    Serializer for Minimuns handling case conversions
    and file omitions as dictated by the API
    """
