...
class PostBillingMinimumsFilterBody(typing_extensions.TypedDict):
    """
...
class _SerializerPostBillingMinimumsFilterBody(pydantic.BaseModel):
    """
    Serializer for PostBillingMinimumsFilterBody handling case conversions
