...
class GetAccountManagementRelatedPersonsResponseDataItemAddressesItem(
    pydantic.BaseModel
):
...
class GetAccountManagementRelatedPersonsResponseDataItemPhoneNumbersItem(
    pydantic.BaseModel
):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
...
class GetAccountManagementRelatedPersonsResponseDataItem(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    addresses: typing.Optional[
        typing.List[GetAccountManagementRelatedPersonsResponseDataItemAddressesItem]
    ...
    phone_numbers: typing.Optional[
        typing.List[GetAccountManagementRelatedPersonsResponseDataItemPhoneNumbersItem]
...
class GetAccountManagementRelatedPersonsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[
        typing.List[GetAccountManagementRelatedPersonsResponseDataItem]
