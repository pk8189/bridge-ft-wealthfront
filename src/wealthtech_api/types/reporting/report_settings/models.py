...
class ReportSetting(pydantic.BaseModel):
    ...
    component: typing.Optional[
        typing_extensions.Literal[
            "client_defaults", "user", "printable", "advisor_defaults"
        ]
...
class GetReportingReportSettingsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[ReportSetting] = pydantic.Field(alias="data", default=None)
...
class PutReportingReportSettingsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PutReportingReportSettingsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetReportingReportSettingsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
