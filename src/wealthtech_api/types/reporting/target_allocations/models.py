...
class TargetAllocationCoefficientsItem(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class TargetAllocation(pydantic.BaseModel):
    ...
    coefficients: typing.Optional[typing.List[TargetAllocationCoefficientsItem]] = (
...
class GetReportingTargetAllocationsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[TargetAllocation] = pydantic.Field(alias="data", default=None)
...
class PostReportingTargetAllocationsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class PutReportingTargetAllocationsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
    ...
    data: typing.Optional[typing.List[TargetAllocation]] = pydantic.Field(
...
class PutReportingTargetAllocationsIdResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
...
class GetReportingTargetAllocationsResponse(pydantic.BaseModel):
    model_config = pydantic.ConfigDict(
        arbitrary_types_allowed=True,
        populate_by_name=True,
    )
