...
class PostReportingBenchmarksFilterBody(typing_extensions.TypedDict):
    """
...
class _SerializerPostReportingBenchmarksFilterBody(pydantic.BaseModel):
    """
    Serializer for PostReportingBenchmarksFilterBody handling case conversions
