...
class PostReportingAssetClassificationsCreateManyBodyItem(typing_extensions.TypedDict):
    """
...
class _SerializerPostReportingAssetClassificationsCreateManyBodyItem(
    pydantic.BaseModel
):
    """
    Serializer for PostReportingAssetClassificationsCreateManyBodyItem handling case conversions
