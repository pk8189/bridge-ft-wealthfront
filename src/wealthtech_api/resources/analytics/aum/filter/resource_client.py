...
from wealthtech_api.types.analytics.aum.filter import params, models
import typing
...
class FilterClient:
    ...
    def create(
        self,
        *,
        data: typing.Optional[params.PostAnalyticsAumFilterBody] = None,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostAnalyticsAumFilterResponse:
        """
        ...
        _json = to_encodable(
            item=data, dump_with=params._SerializerPostAnalyticsAumFilterBody
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/analytics/aum/filter",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostAnalyticsAumFilterResponse,
