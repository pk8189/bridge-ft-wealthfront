...
from wealthtech_api.types.investment_management.models.delete_many import models, params
import typing
...
class DeleteManyClient:
    ...
    def create(
        self,
        *,
        data: params.PostInvestmentManagementModelsDeleteManyBody,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostInvestmentManagementModelsDeleteManyResponse:
        """
        ...
        _json = to_encodable(
            item=data,
            dump_with=params._SerializerPostInvestmentManagementModelsDeleteManyBody,
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/investment-management/models/delete-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostInvestmentManagementModelsDeleteManyResponse,
