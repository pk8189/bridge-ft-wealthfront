...
from wealthtech_api.types.billing.groups.filter import models, params
import typing
...
class FilterClient:
    ...
    def create(
        self,
        *,
        data: typing.Optional[params.PostBillingGroupsFilterBody] = None,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostBillingGroupsFilterResponse:
        """
        ...
        _json = to_encodable(
            item=data, dump_with=params._SerializerPostBillingGroupsFilterBody
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/billing/groups/filter",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostBillingGroupsFilterResponse,
