...
from wealthtech_api.types.billing.asset_adjustments.delete_many import models, params
import typing
...
class DeleteManyClient:
    ...
    def create(
        self,
        *,
        data: params.PostBillingAssetAdjustmentsDeleteManyBody,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostBillingAssetAdjustmentsDeleteManyResponse:
        """
        ...
        _json = to_encodable(
            item=data,
            dump_with=params._SerializerPostBillingAssetAdjustmentsDeleteManyBody,
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/billing/asset-adjustments/delete-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostBillingAssetAdjustmentsDeleteManyResponse,
