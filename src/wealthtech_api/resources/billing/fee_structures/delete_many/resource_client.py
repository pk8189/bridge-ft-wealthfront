...
from wealthtech_api.types.billing.fee_structures.delete_many import models, params
import typing
...
class DeleteManyClient:
    ...
    def create(
        self,
        *,
        data: params.PostBillingFeeStructuresDeleteManyBody,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostBillingFeeStructuresDeleteManyResponse:
        """
        ...
        _json = to_encodable(
            item=data,
            dump_with=params._SerializerPostBillingFeeStructuresDeleteManyBody,
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/billing/fee-structures/delete-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostBillingFeeStructuresDeleteManyResponse,
