...
from wealthtech_api.types.billing.minimums.delete_many import params, models
import typing
...
class DeleteManyClient:
    ...
    def create(
        self,
        *,
        data: params.PostBillingMinimumsDeleteManyBody,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostBillingMinimumsDeleteManyResponse:
        """
        ...
        _json = to_encodable(
            item=data, dump_with=params._SerializerPostBillingMinimumsDeleteManyBody
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/billing/minimums/delete-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostBillingMinimumsDeleteManyResponse,
