...
import typing
from wealthtech_api.types.billing.splits.create_many import params, models
...
class CreateManyClient:
    ...
    def create(
        self,
        *,
        data: typing.List[params.PostBillingSplitsCreateManyBodyItem],
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostBillingSplitsCreateManyResponse:
        """
        ...
        _json = to_encodable(
            ...
            dump_with=typing.List[
                params._SerializerPostBillingSplitsCreateManyBodyItem
            ],
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/billing/splits/create-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostBillingSplitsCreateManyResponse,
