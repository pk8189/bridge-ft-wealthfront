...
from wealthtech_api.types.data.source.lots.filter import params, models
import typing
...
class FilterClient:
    ...
    def create(
        ...
        *,
        ...
        _json = to_encodable(
            item=data, dump_with=params._SerializerPostDataSourceLotsFilterBody
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/data/source/lots/filter",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostDataSourceLotsFilterResponse,
