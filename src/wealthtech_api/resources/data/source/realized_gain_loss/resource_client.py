...
from wealthtech_api.resources.data.source.realized_gain_loss.latest import (
    LatestClient,
    AsyncLatestClient,
)
from wealthtech_api.resources.data.source.realized_gain_loss.filter import (
    AsyncFilterClient,
    FilterClient,
)
import typing
from wealthtech_api.types.data.source.realized_gain_loss import models


class RealizedGainLossClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> models.GetDataSourceRealizedGainLossIdResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/data/source/realized-gain-loss/{id}",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.GetDataSourceRealizedGainLossIdResponse,
    ...
    def list(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.GetDataSourceRealizedGainLossResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path="/data/source/realized-gain-loss",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.GetDataSourceRealizedGainLossResponse,
            request_options=request_options or default_request_options(),
        )
        # end -- send sync request (keep comment for code generation)


class AsyncRealizedGainLossClient:
