...
from wealthtech_api.types.data.source.transactions.latest import params, models
import typing
...
class LatestClient:
    ...
    def list(
        self,
        *,
        data: typing.Optional[params.GetDataSourceTransactionsLatestBody] = None,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.GetDataSourceTransactionsLatestResponse:
        """
        ...
        _json = to_encodable(
            item=data, dump_with=params._SerializerGetDataSourceTransactionsLatestBody
        )
        ...
        return self._base_client.request(
            method="GET",
            path="/data/source/transactions/latest",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.GetDataSourceTransactionsLatestResponse,
