...
from wealthtech_api.resources.data.source.account_balances.latest import (
    LatestClient,
    AsyncLatestClient,
)
from wealthtech_api.resources.data.source.account_balances.filter import (
    AsyncFilterClient,
    FilterClient,
)
import typing
from wealthtech_api.types.data.source.account_balances import models


class AccountBalancesClient:
    ...
    def get(
        ...
        *,
    ...
    ) -> models.GetDataSourceAccountBalancesIdResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path=f"/data/source/account-balances/{id}",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.GetDataSourceAccountBalancesIdResponse,
    ...
    def list(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.GetDataSourceAccountBalancesResponse:
        """
        ...
        return self._base_client.request(
            method="GET",
            path="/data/source/account-balances",
            auth_names=["bearerAuth"],
            query_params=_query,
            cast_to=models.GetDataSourceAccountBalancesResponse,
            request_options=request_options or default_request_options(),
        )
        # end -- send sync request (keep comment for code generation)


class AsyncAccountBalancesClient:
