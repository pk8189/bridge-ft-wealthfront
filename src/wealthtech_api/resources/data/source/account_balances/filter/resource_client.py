...
from wealthtech_api.types.data.source.account_balances.filter import models, params
import typing
...
class FilterClient:
    ...
    def create(
        self,
        *,
        data: typing.Optional[params.PostDataSourceAccountBalancesFilterBody] = None,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        related: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostDataSourceAccountBalancesFilterResponse:
        """
        ...
        _json = to_encodable(
            item=data,
            dump_with=params._SerializerPostDataSourceAccountBalancesFilterBody,
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/data/source/account-balances/filter",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostDataSourceAccountBalancesFilterResponse,
