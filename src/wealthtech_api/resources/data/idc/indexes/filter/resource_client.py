...
from wealthtech_api.types.data.idc.indexes.filter import params, models
import typing
...
class FilterClient:
    ...
    def create(
        self,
        *,
        data: typing.Optional[params.PostDataIdcIndexesFilterBody] = None,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostDataIdcIndexesFilterResponse:
        """
        ...
        _json = to_encodable(
            item=data, dump_with=params._SerializerPostDataIdcIndexesFilterBody
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/data/idc/indexes/filter",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostDataIdcIndexesFilterResponse,
