...
from wealthtech_api.types.jobs.filter import params, models
import typing
...
class FilterClient:
    ...
    def create(
        ...
        *,
        ...
        _json = to_encodable(item=data, dump_with=params._SerializerPostJobsFilterBody)
        ...
        return self._base_client.request(
            ...
            query_params=_query,
            json=_json,
            cast_to=models.PostJobsFilterResponse,
