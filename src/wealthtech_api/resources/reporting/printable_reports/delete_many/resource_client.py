...
from wealthtech_api.types.reporting.printable_reports.delete_many import params, models
import typing
...
class DeleteManyClient:
    ...
    def create(
        self,
        *,
        data: params.PostReportingPrintableReportsDeleteManyBody,
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostReportingPrintableReportsDeleteManyResponse:
        """
        ...
        _json = to_encodable(
            item=data,
            dump_with=params._SerializerPostReportingPrintableReportsDeleteManyBody,
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/reporting/printable-reports/delete-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostReportingPrintableReportsDeleteManyResponse,
