...
import typing
from wealthtech_api.types.reporting.class_tags.create_many import params, models
...
class CreateManyClient:
    ...
    def create(
        self,
        *,
        data: typing.List[params.PostReportingClassTagsCreateManyBodyItem],
        pager_limit: typing.Optional[int] = None,
        pager_page: typing.Optional[int] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> models.PostReportingClassTagsCreateManyResponse:
        """
        ...
        _json = to_encodable(
            ...
            dump_with=typing.List[
                params._SerializerPostReportingClassTagsCreateManyBodyItem
            ],
        )
        ...
        return self._base_client.request(
            method="POST",
            path="/reporting/class-tags/create-many",
            auth_names=["bearerAuth"],
            query_params=_query,
            json=_json,
            cast_to=models.PostReportingClassTagsCreateManyResponse,
